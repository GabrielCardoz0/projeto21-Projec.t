...
describe("POST /tasks", function () {
    describe("when token is invalid", function () {
        it("should be respond with status 401 if no token is given", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, server.post("/tasks")];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, server.post("/tasks").set("Authorization", "Bearer ".concat(token))];
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(401);
                        return [2 /*return*/];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, server.post("/tasks").send(invalidBody).set("Authorization", "Bearer ".concat(token))];
                    case 3:
                        response = _b.sent();
                        expect(response.status).toBe(400);
                        return [2 /*return*/];
    ...
    describe("when credentials is valid", function () {
        it("should be respond with status 404 if no sprint to create tasks", function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, token, task, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, users_factory_1.createUser)()];
                    case 1:
                    ...
                    case 2:
                        ...
                        task = {
                            sprintId: 0,
                            responsible: faker_1.faker.internet.userName(),
                            task: faker_1.faker.lorem.lines(),
                        };
                        return [4 /*yield*/, server.post("/tasks").send(task).set("Authorization", "Bearer ".concat(token))];
                    case 3:
                        response = _a.sent();
        ...
        it("should be respond with status 401 if userId and project userId dont match", function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, user2, token, project, sprint, task, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, users_factory_1.createUser)()];
                    case 1:
        ...
        it("should be respond with status 201 and task", function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, token, project, sprint, task, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, users_factory_1.createUser)()];
                    case 1:
