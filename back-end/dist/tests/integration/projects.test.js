...
describe("POST /projects", function () {
    describe("when token is invalid", function () {
        it("should be respond with status 401 if no token is given", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, server.post("/projects")];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, server.post("/projects").set("Authorization", "Bearer ".concat(token))];
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(401);
                        return [2 /*return*/];
        ...
        it("should be respond with status 400 if body is invalid", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        token = _b.sent();
                        return [4 /*yield*/, server.post("/projects").send(invalidBody).set("Authorization", "Bearer ".concat(token))];
                    case 3:
                        response = _b.sent();
                        expect(response.status).toBe(400);
                        return [2 /*return*/];
    ...
    describe("When token and body is valid", function () {
        it("shoud be respond with status 400 if project name alredy exist", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, server.post("/projects").send(project).set("Authorization", "Bearer ".concat(token))];
                    case 4:
                        response = _a.sent();
...
describe("GET /projects", function () {
    describe("when token is invalid", function () {
        it("should be respond with status 401 if no token is given", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, server.get("/projects")];
                    case 1:
                        response = _a.sent();
                        expect(response.status).toBe(401);
                        return [2 /*return*/];
        ...
        it("should be respond with status 401 if token is invalid", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = faker_1.faker.internet.userName();
                        return [4 /*yield*/, server.get("/projects").set("Authorization", "Bearer ".concat(token))];
                    case 1:
                        response = _a.sent();
    ...
    describe("When token is valid", function () {
        ...
        it("should be respond with status 200 and projects list", function () { return __awaiter(void 0, void 0, void 0, function () {
            var user, token, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, users_factory_1.createUser)()];
